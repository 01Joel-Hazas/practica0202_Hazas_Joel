...
pesoPayaso = 112
pesoMuñeca = 75
numPayasos = int(input("Introduce un número de payasos: "))
numMuñecas = int(input("Introduce un número de muñecas: "))
pesoTotal = (pesoPayaso * numPayasos) + (pesoMuñeca * numMuñecas)
